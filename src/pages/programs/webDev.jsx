...
const FullStackCourse = () => {
  ...
  const logos = [
    "https://1000logos.net/wp-content/uploads/2021/05/BCG-logo.png",
    "https://upload.wikimedia.org/wikipedia/commons/3/3e/Tech_Mahindra_logo.svg",
    "https://upload.wikimedia.org/wikipedia/commons/5/55/Infosys_logo.svg",
    "https://upload.wikimedia.org/wikipedia/commons/5/51/IBM_logo.svg",
    "https://upload.wikimedia.org/wikipedia/commons/1/16/Bosch-logo.svg",
  ];

  const [activeRole, setActiveRole] = useState("Senior Project Manager");
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 bg-white text-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 bg-gray-50 border rounded-lg shadow-sm overflow-hidden">
          {/* Designation Column */}
          ...
          <div className="flex flex-col justify-center items-center text-center px-4 py-6">
            <div className="w-full h-40 bg-blue-100 rounded-md flex items-end justify-around relative">
              <div className="w-4 bg-blue-400 h-[20%]" title="₹5.3L"></div>
              <div className="w-4 bg-blue-500 h-[50%]" title="₹8L"></div>
              <div className="w-4 bg-blue-700 h-[80%]" title="₹10L"></div>
              <div className="w-4 bg-blue-500 h-[50%]" title="₹8L"></div>
              <div className="w-4 bg-blue-400 h-[20%]" title="₹20L"></div>
              <p className="absolute bottom-[-1.5rem] text-sm w-full">
                Source: Glassdoor
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center items-center px-6 py-4 gap-4">
            ...
            <p className="text-sm text-gray-500 mt-2">Source: Indeed</p>
          </div>
        </div>
  ...
  <div className="w-full lg:w-2/3">
    ...
    <div className="bg-white border rounded-lg shadow-md divide-y">
      {[
        ...
        { q: "What does the Simplilearn 100% money-back guarantee mean?", a: "It means you’ll get a full refund if conditions are met and you’re not satisfied." },
