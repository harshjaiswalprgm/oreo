...
const FullStackCourse = () => {
  ...
  const roleLogos = {
    "AutoCAD Draftsman –  Starting Salary (India): ₹2.5 – ₹4.5 LPA": [
    ...
    "Design Engineer (AutoCAD) –  Starting Salary (India): ₹3.5 – ₹6 LPA": [
    ...
    " Starting Salary (India): ₹3 – ₹5.5 LPA Civil CAD Designer –": [
    ...
    "Mechanical CAD Engineer –  Starting Salary (India): ₹3.5 – ₹6.5 LPA": [
    ...
    <>
      ...
      <div className="bg-white text-black px-6 pt-20 pb-0 flex flex-col-reverse md:flex-row items-center justify-between gap-10 max-w-7xl mx-auto">
        ...
        <div className="flex-1 w-full">
          ...
          <ul className="space-y-3 text-gray-800 mb-6">
            <li className="flex items-start">
              ...
              Design real-world 2D & 3D drafting projects from scratch
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Master key AutoCAD tools: layers, dimensions, blocks, layouts
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Industry-oriented training + professional project portfolio
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
          ...
          <div className="flex flex-wrap gap-4 mb-4">
            ...
            <a href="/ProgramsPDF/AutoCAD.pdf" download>
        ...
        <div className="flex-1 w-full flex justify-center max-w-2xl">
          <img
            src="https://img.freepik.com/free-photo/tired-woman-architect-working-modern-cad-program-overtime-sitting-desk-start-up-office-industrial-female-engineer-studying-prototype-idea-pc-showing-cad-software-device-display_482257-13399.jpg?ga=GA1.1.1362237040.1750501614&semt=ais_hybrid&w=740"
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 text-gray-800">
        ...
        <p className="text-gray-600 mb-8 max-w-3xl">
          Glowlogics AutoCAD Training Course covers core concepts essential for
          aspiring design professionals. It includes topics such as 2D drafting,
          3D modeling, advanced drawing tools, layers, annotations, and industry
          best practices. With a strong focus on practical applications, the
          course emphasizes design accuracy, technical skills, and real-world
          project execution—equipping learners with the tools needed to excel in
          fields like architecture, engineering, and construction.
        </p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-8 text-gray-700">
            {[
              ...
              "AutoCAD Shortcuts and Productivity Tools",
            ].map((skill, index) => (
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 bg-white text-gray-800">
        ...
        <p className="mb-8 text-gray-600 max-w-4xl">
          The AutoCAD<sup>®</sup> certification opens doors to high-paying roles
          across diverse industries such as IT, manufacturing, architecture,
          construction, finance, and healthcare. Certified professionals are
          recognized for their design precision, technical expertise, and
          ability to streamline complex workflows. Employers value AutoCAD®
          certified talent for delivering efficient, accurate, and innovative
          project outcomes—often leading to faster career growth, better job
          opportunities, and substantial salary advancements.
        </p>
