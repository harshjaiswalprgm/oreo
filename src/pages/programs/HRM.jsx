...
const FullStackCourse = () => {
  ...
  const roleLogos = {
    "HR Executive –  Starting Salary (India): ₹3 – ₹5.5 LPA": [
    ...
    "Talent Acquisition Specialist – Starting Salary (India): ₹3.5 – ₹6 LPA": [
    ...
    "HR Generalist – Starting Salary (India): ₹4 – ₹6.5 LPA": [
    ...
    "Learning and Development Coordinator – Starting Salary (India): ₹3.5 – ₹6 LPA": [
    ...
    <>
      ...
      <div className="bg-white text-black px-6 pt-20 pb-0 flex flex-col-reverse md:flex-row items-center justify-between gap-10 max-w-7xl mx-auto">
        ...
        <div className="flex-1 w-full">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Become a job-ready HR professional | Master HR operations, payroll,
            recruitment, labor laws & HR analytics
          </p>
          ...
          <ul className="space-y-3 text-gray-800 mb-6">
            <li className="flex items-start">
              ...
              Work on real-world HR case studies and scenarios
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Master recruitment, payroll, compliance & HR analytics tools
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Career mentorship with resume-building & interview readiness
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Includes mock interviews, LinkedIn optimization & soft skills
              training
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
          ...
          <div className="flex flex-wrap gap-4 mb-4">
            ...
            <a href="/ProgramsPDF/HRM.pdf" download>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 text-gray-800">
        ...
        <p className="text-gray-600 mb-8 max-w-3xl">
          The Glowlogics HRM training course is designed to equip learners with
          the essential skills and practical knowledge required to become
          job-ready Human Resource professionals. The course covers core HR
          topics such as talent acquisition, employee onboarding, payroll
          management, performance appraisal, labor laws, and compliance. It also
          includes training in modern HR tools and software like HRMS, Excel for
          HR, and analytics platforms. With a strong focus on real-world HR
          scenarios, documentation, and policy-making, the program prepares
          learners to handle end-to-end HR operations in both startups and large
          organizations.
        </p>
        ...
        <div className="mb-12">
          <div className="flex items-center gap-4 mb-6">
            <h3 className="text-2xl font-semibold">HRM Course Key Features</h3>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-8 text-gray-700">
            {[
              ...
              "HRMS & HRIS Tools (Zoho People, SAP, etc.)",
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 bg-white text-gray-800">
        ...
        <p className="mb-8 text-gray-600 max-w-4xl">
          The HRM<sup>®</sup> certification opens doors to high-demand roles in
          IT, manufacturing, finance, healthcare, education, and various other
          industries. Certified HR professionals are recognized for their
          ability to manage end-to-end human resource functions including
          recruitment, payroll, employee engagement, performance management, and
          compliance. With a deep understanding of labor laws, HR technology
          tools, and people management strategies, HRM<sup>®</sup> certified
          professionals are often trusted with leadership roles and strategic
          responsibilities—leading to faster career growth, higher earning
          potential, and greater impact within organizations.
        </p>
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="w-full lg:w-2/3">
            ...
            <div className="bg-white border rounded-lg shadow-md divide-y">
              {[
                {
    "q": "Who can join this HRM Certification Program?",
    "a": "Engineering, management, and degree students from any year or background can join. No prior HR experience is required."
  },
  {
    "q": "Do I need any specific background before enrolling?",
    "a": "No. The program is designed for beginners and covers HR fundamentals, recruitment processes, and management skills step by step."
  },
  {
    "q": "How long is the HRM certification valid for?",
    "a": "The HRM Certification from Glowlogics is ISO- and MSME-recognized and valid for a lifetime."
  },
  {
    "q": "What skills will I learn in this course?",
    "a": "You’ll learn recruitment and selection, onboarding, employee engagement, payroll handling, performance management, HR software tools, and labor laws."
  },
  {
    "q": "How long is the course, and what is the learning mode?",
    "a": "The course runs for 1–2 months with 30+ hours of live interactive classes, weekly doubt-clearing sessions, and project-based assignments."
  },
  {
    "q": "Will I get a certificate after completing the course?",
    "a": "Yes. You’ll receive an ISO- and MSME-recognized HRM Certification after completing the course and submitting your project work."
  },
  {
    "q": "Is there any placement guarantee?",
    "a": "We provide placement assistance with resume building and interview preparation. Final job offers depend on individual skills and interview results."
  },
  {
