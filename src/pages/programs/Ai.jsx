    ...
    <>
      ...
      <div className="bg-white text-black px-6 pt-20 pb-0 flex flex-col-reverse md:flex-row items-center justify-between gap-10 max-w-7xl mx-auto">
        ...
        <div className="flex-1 w-full">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Become a Job-Ready AI Professional | Master Machine Learning,
            Python, Deep Learning & Real-World AI Applications
          </p>
          ...
          <ul className="space-y-3 text-gray-800 mb-6">
            <li className="flex items-start">
              ...
              Build real-world AI & ML projects from scratch
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Master Python, Machine Learning, Deep Learning, and APIs
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
          ...
          <div className="flex flex-wrap gap-4 mb-4">
            ...
            <a
              href="/public/ProgramsPDF/AI Syllubus.pdf"
              download
            >
        ...
        <div className="flex-1 w-full flex justify-center max-w-2xl">
          <img
            src="https://img.freepik.com/free-vector/ai-futuristic-technology-background_53876-97391.jpg?ga=GA1.1.1362237040.1750501614&semt=ais_hybrid&w=740"
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 text-gray-800">
        ...
        <p className="text-gray-600 mb-8 max-w-3xl">
          At GlowLogics, we’re transforming education through the power of
          artificial intelligence. Our platform combines advanced technology,
          expert-crafted content, and personalized mentorship to deliver a truly
          adaptive and impactful learning experience. Whether you are a student
          preparing for a tech career, a professional looking to upskill, or an
          educator embracing digital change, GlowLogics supports your growth at
          every stage. With AI-driven learning paths, hands-on projects,
          real-world case studies, and 1-on-1 mentorship, you’ll not only learn
          — you’ll apply, build, and grow with confidence. Backed by a
          passionate team of educators, engineers, and data scientists, we’re
          here to help you unlock your full potential in a rapidly evolving
          world.
        </p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-8 text-gray-700">
            {[
              ...
              "Neural Networks, Deep Learning & TensorFlow/PyTorch Basics",
              "Natural Language Processing (NLP) & Text Analytics",
              "Computer Vision & Image Recognition",
              "Model Evaluation, Optimization & Hyperparameter Tuning",
              "AI Deployment & Model Serving (Flask, Streamlit, APIs)",
              "Ethical AI, Bias Mitigation & Responsible AI Practices",
            ].map((skill, index) => (
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 bg-white text-gray-800">
        ...
        <p className="mb-8 text-gray-600 max-w-4xl">
         The AIPro® Certification Program offers a comprehensive pathway to mastering real-world artificial intelligence skills that are in high demand across industries. Learners gain hands-on experience with machine learning, deep learning, NLP, and computer vision through practical projects and expert mentorship. The program also includes resume support, GitHub portfolio building, and job readiness training — helping you stand out in the job market. With lifetime access to learning resources, AI-powered learning paths, and a globally recognized certification, you’ll be equipped to lead innovation and unlock high-growth career opportunities in today is data-driven world.
        </p>
        ...
        <div className="bg-white text-gray-800 p-6 space-y-6">
          ...
          <div>
            ...
            <p>
              The Artificial Intelligence<sup>®</sup> (AIPro) certification is a
              highly regarded credential for individuals aiming to build a
              successful career in AI, machine learning, and intelligent systems
              across diverse industries. This program is ideal for: Aspiring
              AI/ML Engineers, Data Scientists, Python Developers, Software
              Engineers, Research Analysts, Tech Innovators, and any
              professional seeking hands-on experience in AI technologies,
          ...
          <div>
            ...
            <p>
              The AIPro<sup>®</sup> Certification is open to graduates,
              final-year students, software professionals, data enthusiasts, and
              individuals from technical or analytical backgrounds. A basic
              understanding of mathematics, logic, or programming is helpful but
              not mandatory. Anyone with a keen interest in artificial
              intelligence and a passion for innovation is welcome to join.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              There are no mandatory prerequisites to enroll in the AIPro® Certification Program by Glowlogics. The course is beginner-friendly and suitable for learners from both technical and non-technical backgrounds. While prior knowledge of basic mathematics, statistics, or Python can be helpful, it is not required. To earn the certification, learners must complete all course modules, actively participate in live sessions, and successfully complete hands-on AI projects and assessments.
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="w-full lg:w-2/3">
            ...
            <div className="bg-white border rounded-lg shadow-md divide-y">
              {[
                {
                  q: "How to get a Artificial Intelligence® certification?",
                  a: (
                    <ul className="list-disc pl-5 space-y-1 mt-2 text-gray-700">
                      <li>Meet the eligibility requirements</li>
                      <li>
                        Enroll in an accredited Artificial Intelligence certification
                        training course
                      </li>
                      <li>Meet the exam eligibility requirements</li>
                      <li>Apply for the Artificial Intelligence exam with PMI</li>
                      <li>Pass your exam to earn certification</li>
                    </ul>
                  ),
                },
                {
                  q: "What are the Artificial Intelligence certification requirements?",
                ...
                {
                  q: "Do you provide any practice tests as part of the Artificial Intelligence certification course?",
