      ...
      <div className="max-w-7xl mx-auto px-6 py-16 bg-white text-gray-800">
        ...
        <div className="bg-white text-gray-800 p-6 space-y-6">
          ...
          <div>
            ...
            <p>
              VLSI<sup>®</sup> (Very-Large-Scale Integration) is the process of
              creating integrated circuits by combining thousands to millions of
              transistors onto a single chip. It is a key technology behind
              modern electronics, enabling the development of compact,
              high-performance devices such as smartphones, computers, and
              embedded systems. VLSI design plays a crucial role in advancing
              semiconductor technology and is foundational to fields like
            ...
            {[
              {
                ...
                lessons: [
                  ...
                  {
                    name: "VLSI Design Flow: From specification to fabrication",
                  },
                  { name: "Moore's Law and its relevance to VLSI" },
                  { name: "Applications of VLSI in various domains" },
                ],
              },
              {
                title: "Module 2: MOS Transistor Theory",
                lessons: [
                  { name: "MOSFET basics: Structure and operation" },
                  { name: "I-V characteristics of MOS transistors" },
                  {
                    name: "Threshold voltage, mobility, and channel length modulation",
                  },
                  { name: "Scaling of MOS devices" },
                ],
              },
              {
                ...
                lessons: [
                  ...
                  { name: "Static and dynamic power dissipation in CMOS" },
                  { name: "Noise margins, propagation delay, and fan-out" },
                  { name: "CMOS Logic Gates: AND, OR, NAND, NOR, XOR design" },
                ],
              },
              {
                ...
                lessons: [
                  ...
                  {
                    name: "Logic gates, multipliers, and adders (Half and Full Adders)",
                  },
                  { name: "Timing analysis and optimization techniques" },
                  { name: "Introduction to Verilog for combinational design" },
                ],
              },
              {
                title: "Module 5: Sequential Logic Design",
                lessons: [
                  { name: "Latches, flip-flops, and registers" },
                  { name: "Synchronous and asynchronous sequential circuits" },
                  { name: "State machines: Mealy and Moore models" },
                  { name: "Verilog for sequential design" },
                ],
              },
              {
