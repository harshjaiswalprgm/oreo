    ...
    <>
      ...
      <div className="bg-white text-black px-6 pt-20 pb-0 flex flex-col-reverse md:flex-row items-center justify-between gap-10 max-w-7xl mx-auto">
        ...
        <div className="flex-1 w-full">
          ...
          <div className="flex flex-wrap gap-4 mb-4">
            ...
            <a
              href="/public/ProgramsPDF/DS Syllubus-Glowlogics.pdf"
              download
            >
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 text-gray-800">
        ...
        <p className="text-gray-600 mb-8 max-w-3xl">
         GlowLogics’s Data Science Certification Program is a hands-on, instructor-led course that equips you with the skills to master the full data science lifecycle—from data collection and analysis to modeling and deployment. You’ll gain practical experience with tools like Python, Pandas, Scikit-learn, TensorFlow, Power BI, and more. The program covers Machine Learning, Deep Learning, NLP, and Time Series Forecasting through real-world projects. With expert mentorship and dedicated career support, you will graduate as a job-ready, certified data science professional.
        </p>
  ...
  "Ethics in Data Science, Data Privacy & Responsible AI"
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 bg-white text-gray-800">
        ...
        <p className="mb-8 text-gray-600 max-w-5xl">
         The DataSciencePro® Certification Program offers a comprehensive pathway to mastering real-world data science skills that are in high demand across industries. Learners gain hands-on experience with data analysis, machine learning, data visualization, and statistical modeling through practical projects and expert-led mentorship. The program also includes resume support, GitHub portfolio building, and job readiness training — helping you stand out in a competitive job market. With lifetime access to learning resources, guided learning paths, and a globally recognized certification, you will be fully equipped to lead data-driven decision-making and unlock high-growth career opportunities in today is analytics-driven world.
        </p>
        ...
        <div className="bg-white text-gray-800 p-6 space-y-6">
          ...
          <div>
            ...
            <p>
              The Data science<sup>®</sup> (AIPro) certification is a
          ...
          <div>
            ...
            <p>
              There are no mandatory prerequisites to enroll in the AIPro®
              Certification Program by Glowlogics. The course is
              beginner-friendly and suitable for learners from both technical
              and non-technical backgrounds. While prior knowledge of basic
              mathematics, statistics, or Python can be helpful, it is not
              required. To earn the certification, learners must complete all
              course modules, actively participate in live sessions, and
              successfully complete hands-on AI projects and assessments.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  a: (
                    <ul className="list-disc pl-5 space-y-1 mt-2 text-gray-700">
                      ...
                      <li>
                        Enroll in an accredited Data science
                        certification training course
                      </li>
                      <li>Meet the exam eligibility requirements</li>
                      <li>
                        Apply for the Data science exam with PMI
                      </li>
