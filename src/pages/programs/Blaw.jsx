...
const FullStackCourse = () => {
  ...
  const roleLogos = {
    "Legal Associate (Corporate Law) – Starting Salary (India): ₹4 – ₹7 LPA": [
    ...
    "Compliance Officer – Starting Salary (India): ₹3.5 – ₹6.5 LPA": [
    ...
    "Contract Manager –  Starting Salary (India): ₹4 – ₹7 LPA": [
    ...
    "Legal Consultant (Business Law) –  Starting Salary (India): ₹4.5 – ₹8 LPA": [
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 bg-white text-gray-800">
        ...
        <div className="bg-white text-gray-800 p-6 space-y-6">
          ...
          <h2 className="text-2xl font-semibold">
            Business Law Certification Program{" "}
          ...
          <div>
            ...
            <p>
              Business Law<sup>®</sup>  refers to the body of rules and regulations that govern commercial relationships and business transactions. This program is designed to provide learners with a foundational understanding of legal principles related to contracts, intellectual property, employment law, company formation, consumer protection, and dispute resolution. By exploring real-world case studies and legal scenarios, participants will gain the knowledge needed to navigate legal complexities in business operations. Ideal for aspiring entrepreneurs, business professionals, and law enthusiasts, this course ensures you operate within the legal framework while making informed business decisions.
            </p>
          </div>
