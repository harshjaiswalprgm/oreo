...
const FullStackCourse = () => {
  ...
  const roleLogos = {
    "Corporate Communication Executive –  Starting Salary (India): ₹3.5 – ₹6 LPA": [
    ...
    "Public Relations (PR) Associate –  Starting Salary (India): ₹4 – ₹6.5 LPA": [
    ...
    "Content & Communication Specialist – Starting Salary (India): ₹3.5 – ₹6 LPA": [
    ...
    "Client Relationship Executive – Starting Salary (India): ₹3 – ₹5.5 LPA": [
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 bg-white text-gray-800">
        ...
        <div className="bg-white text-gray-800 p-6 space-y-6">
          ...
          <h2 className="text-2xl font-semibold">
            Business Communication Certification Program{" "}
          ...
          <div>
            ...
            <p>
            Business Communication<sup>®</sup>  is the process of sharing information effectively within and outside an organization to achieve business goals. This program focuses on developing essential communication skills such as professional writing, presentation techniques, verbal and non-verbal communication, email etiquette, and interpersonal communication. Learners will also explore how to communicate confidently in meetings, interviews, and corporate settings. Designed for students, job seekers, and professionals, this course helps you build a strong personal and professional presence, ensuring clear, persuasive, and impactful communication in the workplace.
          ...
          <div className="w-full lg:w-1/2 mx-auto relative flex flex-col items-center">
            <div className="bg-[#f9fbff] rounded-xl shadow-md p-8 max-w-md mx-auto text-center border border-orange-600 mb-6">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-4">
                <span className="text-black font-bold">Upcoming</span>
              </h3>
