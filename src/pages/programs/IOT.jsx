...
const FullStackCourse = () => {
  ...
  const roleLogos = {
    "IoT Developer - Starting Salary (India): ₹4 – ₹7.5 LPA": [
    ...
    "Embedded Systems Engineer  - Starting Salary (India): ₹4 – ₹7 LPA": [
    ...
    "IoT Solutions Engineer –  Starting Salary (India): ₹5 – ₹8 LPA": [
    ...
    "IoT Data Analyst –  Starting Salary (India): ₹4 – ₹7 LPA": [
