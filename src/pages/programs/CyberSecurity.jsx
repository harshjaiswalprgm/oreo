...
const FullStackCourse = () => {
  ...
  const roleLogos = {
    "Cybersecurity Analyst –  Starting Salary (India): ₹5 – ₹8 LPA": [
    ...
    "Information Security Analyst – Starting Salary (India): ₹4.5 – ₹7.5 LPA": [
    ...
    "Network Security Engineer – Starting Salary (India): ₹5 – ₹9 LPA": [
    ...
    "Ethical Hacker / Penetration Tester –  Starting Salary (India): ₹5 – ₹8.5 LPA": [
  ...
  return (
    <>
      ...
      <div className="bg-white text-black px-6 pt-20 pb-0 flex flex-col-reverse md:flex-row items-center justify-between gap-10 max-w-7xl mx-auto">
        ...
        <div className="flex-1 w-full">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Become a Job-Ready Cybersecurity Professional | Master Network
            Security, Ethical Hacking, Risk Assessment & Real-World Threat
            Mitigation
          </p>
          ...
          <ul className="space-y-3 text-gray-800 mb-6">
            <li className="flex items-start">
              ...
              Work on real-world cybersecurity projects and simulations
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Master Ethical Hacking, Network Security, Risk Assessment, and SOC
              tools
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Career Mentorship + Build a GitHub & LinkedIn Security Portfolio
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Includes resume support, mock interviews, and job placement
              guidance
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
        ...
        <div className="flex-1 w-full flex justify-center max-w-2xl">
          <img
            src="https://img.freepik.com/free-photo/cyber-security-concept-digital-art_23-2151637765.jpg?ga=GA1.1.1362237040.1750501614&semt=ais_hybrid&w=740"
      ...
      {/* Cyber Security  Overview Section */}
