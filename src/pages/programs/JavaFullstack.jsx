      ...
      <div className="bg-white text-black px-6 pt-20 pb-0 flex flex-col-reverse md:flex-row items-center justify-between gap-10 max-w-7xl mx-auto">
        ...
        FullStack Java
          ...
          <p className="text-lg text-gray-700 mb-6">
           Become a job-ready full-stack developer | Master Core Java, Spring Boot, React, MySQL, and RESTful APIs
          </p>
...
<li className="flex items-start">
  ...
  Guaranteed live cohort batches starting within the next 90 days
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 text-gray-800">
        ...
        <p className="text-gray-600 mb-8 max-w-3xl">
          The GlowlogicsJava FullStack<sup>®</sup> training course is designed to equip aspiring project managers with the core skills and knowledge required to lead modern web development projects successfully. The program covers essential topics including emerging industry trends, latest technologies, best practices, and key project management competencies. With a strong focus on strategic thinking and business acumen, the course also emphasizes the evolving role of a project manager in driving digital transformation and delivering high-impact results.
        </p>
  ...
  "Project Documentation and Reporting",
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 bg-white text-gray-800">
        ...
        <p className="mb-8 text-gray-600 max-w-4xl">
         The Java FullStack<sup>®</sup> certification opens up high-demand career opportunities across IT, manufacturing, finance, healthcare, and many other industries. Certified professionals are recognized for their ability to build and manage end-to-end web applications using technologies like Core Java, Spring Boot, React, and databases. Employers value Java FullStack<sup>®</sup> certified talent for their versatility, problem-solving skills, and ability to contribute to both frontend and backend development—often leading to faster promotions, high-impact roles, and substantial salary growth.
  ...
  <div className="flex flex-col justify-center items-center px-6 py-4 gap-4">
    ...
    <p className="text-sm text-gray-500 mt-2">Source: Glowlogics Solutions</p>
  </div>
</div>
      ...
      {[
        {
          ...
          a: (
            <ul className="list-disc pl-5 space-y-1 mt-2 text-gray-700">
              ...
              <li>Enroll in an accreditedJava FullStackelopment certification training course</li>
        ...
        { q: "What are theJava FullStackelopment certification requirements?", a: "Eligibility criteria vary, usually requiring education and project experience." },
        { q: "How long is theJava FullStackelopment certification valid for?", a: "WebDevelopment certification is valid for 3 years and requires renewal." },

        { q: "How to schedule your examination after completingJava FullStackelopment certification training?", a: "Log in to PMI, select an exam center/date, and follow the scheduling steps." },
        { q: "Do you provide any practice tests as part of theJava FullStackelopment certification course?", a: "Yes, we provide full-length mock tests and practice questions." },
        { q: "Do you provide any practice tests as part of theJava FullStackelopment certification course?", a: "Yes, we provide full-length mock tests and practice questions." },
        { q: "Do you provide any practice tests as part of theJava FullStackelopment certification course?", a: "Yes, we provide full-length mock tests and practice questions." },
        { q: "Do you provide any practice tests as part of theJava FullStackelopment certification course?", a: "Yes, we provide full-length mock tests and practice questions." },
        ...
        <div key={idx} className="group">
          ...
          >
            {item.q}
            <span className="text-xl">{openSection === idx ? "−" : "+"}</span>
          </button>
          {openSection === idx && (
            <div className="px-6 pb-4 text-sm text-gray-700">{item.a}</div>
          )}
        </div>
      ))}
    </div>
    ...
    <div className="flex w-max animate-marquee space-x-8 px-8 items-start">
      {[
        ...
        >
          ...
          <p className="text-gray-800 text-base mb-6 leading-relaxed">{item.text}</p>
