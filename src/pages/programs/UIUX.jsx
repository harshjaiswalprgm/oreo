...
const FullStackProgram = () => {
  ...
  const roleLogos = {
    ...
    "Product Designer - Starting Salary (India): ₹5 – ₹8 LPA": [
    ...
    "Interaction Designer - Starting Salary (India): ₹4 – ₹7 LPA": [
    ...
    <>
      ...
      <div className="bg-white text-black px-6 pt-20 pb-0 flex flex-col-reverse md:flex-row items-center justify-between gap-10 max-w-7xl mx-auto">
        ...
        <div className="flex-1 w-full">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Become a Job-Ready UI/UX Designer | Master Design Thinking, Figma,
          ...
          <ul className="space-y-3 text-gray-800 mb-6">
            <li className="flex items-start">
              ...
              Design real-world UI/UX projects from scratch using Figma & Adobe
              XD
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
            ...
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Includes resume review, mock interviews & LinkedIn profile
              optimization
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 text-gray-800">
        ...
        <p className="text-gray-600 mb-8 max-w-3xl">
          Glowlogics UI/UX Design Training Program covers all the essential
          skills needed to become a modern, user-centric designer. The Program
          focuses on key areas such as design thinking, user research,
          wireframing, prototyping, and usability testing. Learners will explore
          emerging trends in UI/UX, the latest design tools like Figma and Adobe
          XD, and best practices in responsive and accessible design. With a
          strong focus on real-world applications and portfolio-building, this
          program equips you to create seamless, engaging digital experiences
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 bg-white text-gray-800">
        ...
        <p className="mb-8 text-gray-600 max-w-4xl">
          ...
          UIUX® certified project managers drive better project performance and
          are often rewarded with substantial pay raises as shown below.
        </p>
