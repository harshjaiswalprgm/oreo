...
const FullStackCourse = () => {
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 text-gray-800">
        ...
        <p className="text-gray-600 mb-8 max-w-3xl">
          The Glowlogics Leadership training course is designed to equip aspiring and current professionals with the essential skills required to lead teams, drive change, and make strategic decisions in dynamic business environments. The course covers core leadership competencies such as emotional intelligence, strategic thinking, team management, conflict resolution, and decision-making. It also includes training in communication, delegation, goal setting, and performance management. With real-world leadership simulations, case studies, and personalized coaching, the program prepares individuals to step into leadership roles across corporate, startup, and nonprofit sectors with confidence and clarity.
        </p>

        {/* Key Features */}
        <div className="mb-12">
          <div className="flex items-center gap-4 mb-6">
            <h3 className="text-2xl font-semibold">Leadership Course Key Features</h3>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 bg-white text-gray-800">
        ...
        <p className="mb-8 text-gray-600 max-w-4xl">
         The Leadership<sup>®</sup> certification empowers professionals to step into high-impact roles across industries such as IT, finance, healthcare, education, and business management. Certified leaders are recognized for their ability to inspire teams, drive strategic initiatives, make informed decisions, and manage change effectively. With a strong foundation in communication, emotional intelligence, and organizational leadership, Leadership<sup>®</sup> professionals are often promoted to managerial and executive positions—leading to accelerated career growth, increased influence, and substantial salary advancements.
  ...
  <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-4">
    Self placed <span className="text-black font-bold">Classes</span>
  </h3>
