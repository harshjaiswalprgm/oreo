...
const FullStackCourse = () => {
  ...
  const roleLogos = {
    "Management Trainee - Starting Salary (India): ₹4 – ₹6 LPA": [
    ...
    "Team Lead (Entry Level) - Starting Salary (India): ₹5 – ₹7 LPA": [
    ...
    "Operations Executive  - Starting Salary (India): ₹3.5 – ₹6.5 LPA": [
    ...
    "Project Coordinator - Starting Salary (India): ₹4 – ₹6.5 LPA": [
    ...
    <>
      ...
      <div className="bg-white text-black px-6 pt-20 pb-0 flex flex-col-reverse md:flex-row items-center justify-between gap-10 max-w-7xl mx-auto">
        ...
        <div className="flex-1 w-full">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Become a job-ready leader | Master strategic thinking, team
            management, decision-making, emotional intelligence & organizational
            leadership
          </p>
          ...
          <ul className="space-y-3 text-gray-800 mb-6">
            <li className="flex items-start">
              ...
              Practice leadership through real-world case studies and group
              exercises
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Master strategic thinking, conflict resolution, and team
              management
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Personalized mentorship to help you lead with confidence and
              clarity
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
              Includes mock interviews, executive presence & communication
              training
            </li>
            <li className="flex items-start">
              <FaCheckCircle className="text-green-500 mt-1 mr-2" />
        ...
        <div className="flex-1 w-full flex justify-center max-w-2xl">
          <img
            src="https://img.freepik.com/free-photo/three-business-people-meeting_23-2147626533.jpg?ga=GA1.1.1362237040.1750501614&semt=ais_hybrid&w=740"
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 text-gray-800">
        ...
        <p className="text-gray-600 mb-8 max-w-3xl">
          The Glowlogics Leadership training course is designed to equip
          aspiring and current professionals with the essential skills required
          to lead teams, drive change, and make strategic decisions in dynamic
          business environments. The course covers core leadership competencies
          such as emotional intelligence, strategic thinking, team management,
          conflict resolution, and decision-making. It also includes training in
          communication, delegation, goal setting, and performance management.
          With real-world leadership simulations, case studies, and personalized
          coaching, the program prepares individuals to step into leadership
          roles across corporate, startup, and nonprofit sectors with confidence
          and clarity.
        </p>
        ...
        <div className="mb-12">
          <div className="flex items-center gap-4 mb-6">
            <h3 className="text-2xl font-semibold">
              Leadership Course Key Features
            </h3>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-8 text-gray-700">
            {[
              ...
              "Payroll Management & Compensation Planning",
              "Performance Appraisal Systems",
              "HR Policies, Compliance & Labor Laws",
              "Conflict Resolution & Employee Relations",
              "LeadershipS & HRIS Tools (Zoho People, SAP, etc.)",
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 bg-white text-gray-800">
        ...
        <p className="mb-8 text-gray-600 max-w-4xl">
          The Leadership<sup>®</sup> certification empowers professionals to
          step into high-impact roles across industries such as IT, finance,
          healthcare, education, and business management. Certified leaders are
          recognized for their ability to inspire teams, drive strategic
          initiatives, make informed decisions, and manage change effectively.
          With a strong foundation in communication, emotional intelligence, and
          organizational leadership, Leadership<sup>®</sup> professionals are
          often promoted to managerial and executive positions—leading to
          accelerated career growth, increased influence, and substantial salary
          advancements.
        </p>
        ...
        <div className="bg-white text-gray-800 p-6 space-y-6">
          ...
          <div>
            ...
            <p>
              Leadership<sup>®</sup> is the ability to inspire, influence, and
              guide individuals or teams toward achieving a common goal. This
              program is designed to equip learners with essential leadership
              skills such as strategic thinking, effective communication, team
              management, decision-making, and emotional intelligence. Whether
              you are preparing for a managerial role or aiming to lead with
              confidence in your current position, the Leadership Program helps
              you develop the mindset and capabilities needed to lead with
              purpose, drive innovation, and create a positive impact within any
          ...
          <div className="mt-8 space-y-3">
            ...
            {[
              ...
              {
                title:
                  "Module2: Team Building, Conflict Management, and Mentoring",
                lessons: [
              ...
              {
                title:
                  "Module 4 : Situational Awareness, Servant Leadership and Emotional Intelligence",
                lessons: [
                  {
              ...
              },
              {
                ...
                lessons: [{ name: "Leadership and Management Styles." }],
              },
            ].map((section, index) => (
              <div
                key={index}
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="w-full lg:w-2/3">
            ...
            <div className="bg-white border rounded-lg shadow-md divide-y">
              {[
                {
                  q: "Who can join this Leadership & Management Certification Program?",
                  a: "Engineering, management, and degree students from any year or background can join. No prior experience in leadership or management is required.",
                },
                {
                  q: "Do I need any specific background before enrolling?",
                  a: "No. The program is designed for beginners and covers both fundamental and advanced leadership and management skills.",
                },
                {
                  q: "How long is the Leadership & Management certification valid for?",
                  a: "The certification is ISO- and MSME-recognized and valid for a lifetime.",
                },
                {
                  q: "What skills will I learn in this course?",
                  a: "You’ll learn people management, team leadership, communication strategies, decision-making, project management basics, and organizational behavior.",
                },
                {
                  q: "How long is the course, and what is the learning mode?",
                  a: "The course typically runs for 1–2 months. It is completely self-paced with recorded sessions and reading materials. Live classes are not part of this program.",
                },
                {
                  q: "Will I get a certificate after completing the course?",
                  a: "Yes. Upon completing all modules and assessments, you’ll receive an ISO- and MSME-recognized Leadership & Management Certification.",
                },
                {
                  q: "Is there any placement guarantee?",
                  a: "We provide placement assistance for management-related roles, but final job offers depend on individual skills, performance, and interviews.",
                },
                {
