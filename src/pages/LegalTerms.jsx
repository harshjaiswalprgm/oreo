      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        ...
        <div className="space-y-6 text-sm md:text-base text-justify">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li className="font-semibold">{`In case of any refunds approved by Glowlogics Solutions private limited, it will take 7 days for the refund to be processed to you.`}</li>
            <li className="font-semibold">{`It will take 7 days for the refund to be credited to you in original method.`}</li>
          </ul>
        </div>
