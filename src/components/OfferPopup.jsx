...
const OfferPopup = () => {
  ...
  <p className="text-sm md:text-base mb-4 text-gray-700 dark:text-gray-300">
    Refer <strong>3 friends</strong> and get <strong>₹500 cashback</strong> after their successful sign-up.
    Your friends will also get <strong>One complementary</strong> program on their first enrollment.
  </p>

  <div className="flex items-start gap-2 mb-4">
    <input type="checkbox" id="subscribe" className="mt-1" />
    <label htmlFor="subscribe" className="text-xs md:text-sm text-gray-600 dark:text-gray-400">
